...
- Asset 3: Hệ thống đăng nhập của website
...
## 4. Reflection
Nếu là quản trị viên hệ thống, em sẽ ưu tiên xử lý vấn đề về tính toàn vẹn dữ liệu trước. Vì việc điểm số bị thay đổi có thể ảnh hưởng trực tiếp đến kết quả học tập của sinh viên. Điều này cũng làm giảm sự tin tưởng vào hệ thống. Sau đó em sẽ cải thiện khả năng truy cập của hệ thống và tăng cường bảo mật dữ liệu. Một hệ thống ổn định và an toàn sẽ giúp sinh viên và giảng viên yên tâm sử dụng.
